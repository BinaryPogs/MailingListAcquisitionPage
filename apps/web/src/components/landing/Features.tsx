      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
        {features.items.map((feature, index) => {
          ...
          return (
            ...
            >
              <Card className="bg-white/[0.03] backdrop-blur-xl border-white/[0.05] hover:bg-white/[0.05] transition-all duration-300 transform hover:-translate-y-1">
                <CardHeader>
                  <motion.div
                  ...
                  <h3 className="text-2xl font-semibold text-center text-white mt-6">
                    {feature.title}
                  </h3>
                </CardHeader>
                <CardContent>
